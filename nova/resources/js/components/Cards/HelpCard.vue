  ...
  <div class="flex justify-center items-centers">
    <div class="w-full max-w-xl">
      ...
      <p class="text-90 leading-tight mb-8">
       Добро пожаловать в Нову! Познакомьтесь с Нова и изучите ее возможности в
        документациb:
      </p>
          ...
          <tr>
            <td class="align-top w-1/2 border-r border-b border-50">
              <a :href="resources" class="no-underline dim flex p-6">
                ...
                <div>
                  <heading :level="3" class="mb-3">Ресурсы</heading>
                  <p class="text-90 leading-normal">
                    Менеджер ресурсов Нова позволяет быстро просматривать и
                    управлять записями о моделях Eloquent прямо из Нова
            ...
            <td class="align-top w-1/2 border-b border-50">
              <a :href="actions" class="no-underline dim flex p-6">
                ...
                <div>
                  <heading :level="3" class="mb-3"> Действия</heading>
                  <p class="text-90 leading-normal">
                   Действия выполняют задачи для одной записи или всего пакета
                    записей. Есть действие, которое требует времени? Без проблем.
                    Нова может поставить их в очередь, используя мощную систему очередей Ларавель.
                  </p>
                </div>
              </a>
            </td>
          ...
          <tr>
            <td class="align-top w-1/2 border-r border-b border-50">
              <a :href="filters" class="no-underline dim flex p-6">
                ...
                <div>
                  <heading :level="3" class="mb-3">Фильтры</heading>
                  <p class="text-90 leading-normal">
                    Напишите собственные фильтры для индексов ресурсов, чтобы предлагать свои
                    пользователи быстро просматривают различные сегменты ваших данных.
                  </p>
                </div>
              </a>
            </td>
            ...
            <td class="align-top w-1/2 border-b border-50">
              <a :href="lenses" class="no-underline dim flex p-6">
                ...
                <div>
                  <heading :level="3" class="mb-3">Линзы</heading>
                  <p class="text-90 leading-normal">
                    Необходимо настроить список ресурсов чуть больше, чем
                    фильтр может предоставить? Без проблем. Добавьте линзы на свой ресурс
                    чтобы получить полный контроль над всем запросом Eloquent.
                  </p>
                </div>
              </a>
            </td>
          ...
          <tr>
            <td class="align-top w-1/2 border-r border-b border-50">
              <a :href="metrics" class="no-underline dim flex p-6">
                ...
                <div>
                  <heading :level="3" class="mb-3">Метрики</heading>
                  <p class="text-90 leading-normal">
                    Нова позволяет безболезненно быстро отображать пользовательские метрики для
                    ваше приложение. Чтобы положить вишенку сверху, мы включили
                    помощники запросов, чтобы все упростить.
                  </p>
                </div>
              </a>
            </td>
            ...
            <td class="align-top w-1/2 border-b border-50">
              <a :href="cards" class="no-underline dim flex p-6">
                ...
                <div>
                  <heading :level="3" class="mb-3">Карты</heading>
                  <p class="text-90 leading-normal">
                   Нова предлагает генераторы интерфейса командной строки для создания собственных строительных лесов.
                    открытки. Мы дадим вам компонент Vue и бесконечное
                    возможности.
                  </p>
                </div>
              </a>
